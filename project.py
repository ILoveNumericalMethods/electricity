...
class Project:
    ...
    def __init__(self, WIDTH, HEIGHT, black_screen_x, black_screen_y):
        ...
        self.input_area = Input_area(self.screen_x[0], INPUT_AREA_Y[0], \
           self.screen_x[1] - self.screen_x[0], INPUT_AREA_Y[1] - INPUT_AREA_Y[0])
    ...
    def render_text(self):
        ...
        width = max(self.screen_x[1] - self.screen_x[0], txt_surface.get_width() + INPUT_AREA_Y[0])
